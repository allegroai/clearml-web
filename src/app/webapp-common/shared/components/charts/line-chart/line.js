define(function(require){
    ...
    const { exportChart } = require('britecharts/src/charts/helpers/export');
    const colorHelper = require('britecharts/src/charts/helpers/color');
    const { line: lineChartLoadingMarkup } = require('britecharts/src/charts/helpers/load');

    const { getTimeSeriesAxis } = require('britecharts/src/charts/helpers/axis');
    const {
        axisTimeCombinations,
        curveMap
    } = require('britecharts/src/charts/helpers/constants');
    const {
        createFilterContainer,
        createGlowWithMatrix,
        bounceCircleHighlight
    } = require('britecharts/src/charts/helpers/filter');
    const {
        formatIntegerValue,
        formatDecimalValue,
        isInteger,
        uniqueId
    } = require('britecharts/src/charts/helpers/number');
    ...
    return function module() {
        ...
        function buildScales(){
            ...
            yScale = d3Scale.scaleLinear()
                .domain([yScaleBottomValue, Math.max(1, Math.abs(maxY))])
