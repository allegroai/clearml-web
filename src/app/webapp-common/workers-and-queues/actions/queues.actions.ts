...
import {TableSortOrderEnum} from '../../../webapp-common/shared/ui-components/data/table/table.consts';
...
export class GetQueues implements Action {
  type = GET_QUEUES;
...
export class QueuesTableSortChanged implements Action {
  public type = QUEUES_TABLE_SORT_CHANGED;
