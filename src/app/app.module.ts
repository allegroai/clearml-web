...
import { UserDomainModule } from '@common/settings/user-domain.module';
import { userDashboardReducer } from '@common/settings/user-domain.reducer';
import { } from '@common/settings/user-domain.reducer';
@NgModule({
  ...
  imports: [
    ...
    SMSharedModule,
    AngularSplitModule,
    StoreModule.forFeature('userpage', userDashboardReducer),
    UserDomainModule,
