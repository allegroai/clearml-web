...
export class ApiUsersService {
  ...
  /**
       ...
       * @param reportProgress flag to report request and response progress.
       */
  public usersGetAllUsers(request: UsersGetAllRequest, options?: any, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    if (request === null || request === undefined) {
      throw new Error('Required parameter request was null or undefined when calling usersGetAll.');
    }
    ...
    return this.apiRequest.post<UsersGetAllResponse>(`${this.basePath}/users.get_all_users`,
      request,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
